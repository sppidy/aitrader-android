...
import com.sppidy.janus.model.ChatHistoryItem
import com.sppidy.janus.model.ChatRequest
import com.sppidy.janus.util.PollingPolicy
...
class ChatViewModel : ViewModel() {
    ...
    private val _messages = MutableStateFlow<List<ChatMessage>>(
        listOf(
            ChatMessage(
                role = "assistant",
                content = if (com.sppidy.janus.AppPreferences.getMarketMode() == "FOREX")
